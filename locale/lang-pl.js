SnapTranslator.dict.pl = { ...SnapTranslator.dict.pl,
    ...
    "Broadcasts generated by the MicroBlocks device will automatically be received on the Asterisk* side after connecting.": "Wiadomości wygenerowane przez urządzenie MicroBlocks będą automatycznie odbierane przez Asterisk* po połączeniu.",
    ...
    "Customize the display of the Asterisk* UI to create a microworld programming environment.": "Dostosuj interfejs Snap, aby stworzyć środowisko programistyczne mikroświata.",
	...
	"Interact with MicroBlocks devices over a USB cable or wirelessly through BLE. Broadcasts generated by the MicroBlocks device will automatically be received on the Asterisk* side after connecting.": "Interakcja z urządzeniami MicroBlocks przez kabel USB lub bezprzewodowo przez BLE. Wiadomości wygenerowane przez urządzenie MicroBlocks będą automatycznie odbierane przez Asterisk* po połączeniu.",
    ...
    "January": "Styczeń",
    "JavaScript extensions for Asterisk*\nare turned off": "Rozszerzenia JavaScript dla Asterisk*\nsą wyłączone",
    ...
    "Persistent key-value storage across Asterisk* sessions in the same browser": "Przechowywanie danych klucz-wartość w pamięci Asterisk* w tej samej przeglądarce",
	...
	"Snap for All firmata boards Connector. Connecting Asterisk* to any Firmata compatible board: UNO, Nano, Mega, Leonardo, Micro, Due, 101, ESP8266, NodeMCU... to dynamically control their functionalities. Firmata firmware uploaded is required.": "Wtyczka Asterisk* dla wszystkich płytek kompatybilnych z Firmata: UNO, Nano, Mega, Leonardo, Micro, Due, 101, ESP8266, NodeMCU... do dynamicznego sterowania ich funkcjami. Wymagane jest załadowanie oprogramowania Firmata.",
    "Asterisk* website": "Strona Asterisk*",
    "Asterisk*Cloud": "Chmura Asterisk*",
    ...
    "Text to speech": "Tekst na mowę",
    "Text": "Tekst",
    "The full Scheme numeric tower.  \"USE BIGNUMS <True>\" to enable.": "Pełna wieża numeryczna Scheme. Użyj bloku \"system liczbowy Scheme <Prawda>\", aby ją włączyć.",
    ...
    "experimental! make this reporter fast and uninterruptable CAUTION: Errors in the ring can break your Asterisk* session!": "eksperymentalne! sprawi, że ta funkcja będzie działała szybko i nieprzerwanie UWAGA: Błędy w pierścieniu mogą przerwać działanie Asterisk*",
