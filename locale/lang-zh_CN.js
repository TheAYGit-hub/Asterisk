SnapTranslator.dict.zh_CN = { ...SnapTranslator.dict.zh_CN,
    ...
    "current parent": "目前的父对象",
    "Custom Block Translations": "自制积木的翻译",
    "custom?": "是自制积木?",
    "Customize primitives": "自定义原生积木",
    "Customize the display of the Asterisk*Ul to create a microworld programming environment.": "自定义 Asterisk*Ul 的显示，以创建一个微观世界编程环境。",
    "cut from _": "从 _ 剪切",
    "d": "d",
    "dangling?": "是否为组合面的组合面？",
    "darker": "调黑",
    ...
    "experimental!\nmake this reporter fast and uninterruptable\nCAUTION: Errors in the ring\ncan break your Asterisk* session!": "实验性功能！\n这一功能可以使该返回类积木运行得更快且不可中断。\n当心：任何在环里出现的报错\n都可能会令当前Asterisk*编辑器崩溃！",
    "EXPERIMENTAL! check to enable\n live custom control structures": "实验性功能！勾选以启用实时自定义控制结构",
    "EXPERIMENTAL! check to enable\nsupport for compiling": "实验性功能！勾选以启用编译支持",
    "experimental! make this reporter fast and uninterruptable CAUTION: Errors in the ring can break your Asterisk* session!": "实验性！使这个报告器快速和不可中断。注意：环中的错误可能会破坏您的Snap！会话！",
    ...
    "generate a Parson's Puzzle\nfrom the current sprite": "从当前角色生成程序复原题(即Parson谜题)",
    ...
    "inspect...": "查看...",
    "Interact with MicroBlocks devices over a USB cable or wirelessly through BLE.Broadcasts generated by the MicroBlocks device will automatically be received on the Asterisk*side after connecting.": "通过 USB 线缆或通过 BLE 无线连接与 MicroBlocks 设备进行交互。在连接后，MicroBlocks 设备生成的广播将自动在 Asterisk* 端接收。",
    ...
    "JavaScript extensions for Asterisk* are turned off": "未解除JavaScript Function积木的使用限制",
    ...
    "Persistent key-value storage across Asterisk* sessions in the same browser": "在同一浏览器中跨Asterisk*会话保持持久化的键值存储,这是关于在Asterisk*编程环境中实现在不同会话之间保持数据持久性的描述。",
    "piano keyboard": "钢琴键盘",
    "pic...": "展示图片...",
    ...
    "smallStage": "小舞台",
    "snap": "快照",
    "Asterisk* website": "官方网站",
    "Asterisk*Cloud": "Snap！云端",
    "solutions": "程序复原题的预设答案",
    ...
    "Project Settings": "作品设置",
    "Editor": "编辑器",
    "Project": "作品",
    "Accessibility": "无障碍访问",
    "Contrast blocks": "交替积木颜色",
    "Restore palette": "重置积木面板",
    "extract solution": "公开预设答案",
    "delete solution": "删除预设答案",
    "Include settings": "可选设置",
    "All": "全部",
    "Sports": "体育器材",
    "Animals": "动物",
    "Body Parts": "身体",
    ...
    "Shapes": "形状",
    "Transportation": "交通工具",
    "new process _ _": "创建新线程 _ _",
    "_ of process _": "属性 _ 自线程 _",
