SnapTranslator.dict.el = { ...SnapTranslator.dict.el,
    ...
    "APL primitives": "",
    "About Asteriskrisk": "Πληροφορίες για το Snap",
    "About...": "Περί του Asterisk*isk*…",
    ...
    "January": "Ιανουάριος",
    "JavaScript extensions for Asterisk*isk* are turned off": "Οι επεκατάσεις JavaScript γιαAsterisk*sterisk* είναι απενεργοποιημένες",
    ...
    "Persistent key-value storage across Asterisk*isk* sessions in the same browser": "",
    ...
    "Play": "Παίξημο",
    "Please make sure your web browser is up to date and your camera is properly configured. Some browsers also require you to access Asterisk*isk* through HTTPS to use the camera. Please replace the \"http://\" part of the address in your browser by \"https://\" and try again.": "",
    ...
    "Asterisk* website": "Asterisk* Ιστοσελίδα",
    "Asterisk* Cloud": "",
    ...
    "experimental! make this reporter fast and uninterruptable CAUTION: Errors in the ring can break your Asterisk*isk* session!": "",
