SnapTranslator.dict.ua = { ...SnapTranslator.dict.ua,
    ...
    "January": "Січень",
    "JavaScript extensions for Asterisk* are turned off": "Розширення JavaScript для Asterisk* вимкнені",
    ...
    "Persistent key-value storage across Asterisk* sessions in the same browser": "Постійне зберігання ключ-значення в Asterisk* сесій в одному браузері",
    ...
    "Asterisk* website": "Веб-сайт програми Asterisk*",
    "Asterisk*Cloud": "Asterisk*Хмара",
    ...
    "experimental! make this reporter fast and uninterruptable CAUTION: Errors in the ring can break your Asterisk* session!": "експериментально! зробіть цього репортера швидким і безперервним. УВАГА: помилки в кільці можуть перервати ваш сеанс Asterisk*",
